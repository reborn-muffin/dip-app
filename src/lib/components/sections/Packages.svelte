        ...
        <div class="col-md-4 col-sm-6">
          <div class="single-package-item">
            ...
            <div class="single-package-item-txt">
              ...
              <div class="about-btn">
                <button on:click={showPopup} class="about-view packages-btn">
                  book now
                </button>
              </div><!--/.about-btn-->
